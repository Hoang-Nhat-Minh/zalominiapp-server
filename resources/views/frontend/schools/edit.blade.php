...
@section('content')
    <main class="admin-content-wrapper school-edit-wrapper" style="padding: 28px; max-width: 1000px; margin: 0 auto;">
        <!-- Header & Breadcrumb Navigation -->
        <div style="margin-bottom: 28px; display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
            <div style="display: flex; align-items: center; gap: 14px;">
                <a href="{{ route('schools.index') }}" class="admin-btn admin-btn-secondary" style="padding: 9px 14px; border-radius: 8px;">
                    <i class="ph ph-arrow-left" style="font-size: 18px;"></i> Quay lại
                </a>
                <div>
                    <h1 style="font-size: 22px; font-weight: 700; color: var(--text-main); margin: 0; display: flex; align-items: center; gap: 8px;">
                        <i class="ph ph-pencil-simple-line" style="color: var(--primary); font-size: 26px;"></i>
                        Chỉnh sửa thông tin cơ sở giáo dục
                    </h1>
                    <p style="color: var(--text-muted); font-size: 13.5px; margin: 3px 0 0 0;">Cập nhật chi tiết cho: <strong style="color: var(--primary);">{{ $school->name }}</strong></p>
                </div>
            </div>
        </div>
        ...
        @if ($errors->any())
            <div style="padding: 14px 18px; background-color: var(--danger-bg, #FFEBEE); border: 1px solid var(--danger-border, #FFCDD2); color: var(--danger, #D32F2F); border-radius: 10px; margin-bottom: 24px; display: flex; align-items: flex-start; gap: 12px; box-shadow: 0 2px 8px rgba(211, 47, 47, 0.08);">
                <i class="ph ph-warning-circle" style="font-size: 22px; flex-shrink: 0; margin-top: 1px;"></i>
                <div>
                    <strong style="font-size: 14px; display: block; margin-bottom: 4px;">Vui lòng kiểm tra lại thông tin nhập vào:</strong>
        ...
        <div class="gov-card">
            <div class="gov-card-header">
                <h2 class="gov-card-title">
                    ...
                    Cập nhật cơ sở giáo dục
                </h2>
                <span style="font-size: 12.5px; color: var(--text-muted);"><span class="required" style="color: #EF4444;">*</span> Bắt buộc nhập</span>
            </div>
            ...
            <form action="{{ route('schools.update', $school->id) }}" method="POST">
                ...
                <div class="gov-card-body">
                        ...
                        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px;">
                            <div>
                                ...
                                <div class="gov-input-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $school->name) }}" placeholder="Nhập tên trường học..." class="e-input" required>
                                </div>
                            </div>
                            <div>
                    ...
                    <div class="gov-form-section">
                        ...
                        <div class="gov-form-section-desc">Địa chỉ chính xác và các kênh liên lạc chính thức với nhà trường</div>

                        <div style="margin-bottom: 20px;">
                            <label class="gov-label">Địa chỉ chính xác <span class="required">*</span></label>
                            <div class="gov-input-group">
                                <i class="ph ph-map-pin gov-input-icon"></i>
                                <input type="text" name="address" value="{{ old('address', $school->address) }}" placeholder="Số nhà, tên đường, tổ dân phố, phường/xã..." class="e-input" required>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                            ...
                            <div>
                                ...
                                <div class="gov-input-group">
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $school->email) }}" placeholder="Nhập email..." class="e-input">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="gov-input-group">
                                    ...
                                    <input type="url" name="website" value="{{ old('website', $school->website) }}" placeholder="https://example.edu.vn..." class="e-input">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gov-form-section">
                        ...
                        <div class="gov-form-section-desc">Tọa độ để người dân chỉ đường chính xác trên Zalo Mini App bản đồ</div>
                    ...
                    <div class="gov-form-section">
                        ...
                        <div class="gov-form-section-desc">Mô tả ngắn gọn về truyền thống, quy mô hoặc lưu ý cho người dân</div>

                        <div>
                            <label class="gov-label">Giới thiệu ngắn về nhà trường</label>
                            <textarea name="description" rows="4" placeholder="Nhập tóm tắt lịch sử thành lập, cơ sở vật chất..." class="e-input">{{ old('description', $school->description) }}</textarea>
                        </div>
                    </div>
                ...
                <div class="gov-card-footer">
                    ...
                    <button type="submit" class="admin-btn admin-btn-primary">
                        <i class="ph ph-floppy-disk"></i> Cập nhật thông tin
                    </button>
                </div>
            </form>
        </div>
